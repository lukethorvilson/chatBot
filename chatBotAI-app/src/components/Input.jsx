...
function Input({ userInput, setUserInput, handleSubmit }) {
  return (
    <>
        <form className="absolute bottom-0 flex h-16 w-full gap-4 bg-gray-200 pb-2 pl-6 lg:justify-center" onSubmit={(e) => handleSubmit(e)}>
          <input
          ...
          ></input>
          <button type="submit" className="h-[70%] w-[15%] rounded-3xl bg-green-500 text-white transition-colors hover:bg-green-600 md:w-[10%] lg:w-[100px]">
            Send
          </button>
        </form>
    </>
